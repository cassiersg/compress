...
def parse_reports(reports):
    for report in reports:
        ...
        yield {'design': module, 'nshares': nshares, 'latency': latency, 'area_ge': area_ge, 'area_ge_wrng': area_ge+area_rng, 'solve_time': solve_time}
...
def main():
    ...
    with open(args.outcsv, 'w') as csvfile:
        fields=['design', 'latency', 'nshares', 'area_ge', 'area_ge_wrng', 'solve_time']
