...
COMPRESS itself is a python3 script (tested with python3.13), with dependencies given in `requirements.txt`.

Other parts of the flow use iverilog (tested with version 0.14) and yosys
(tested with version 0.52) respectively for simulation and area usage
